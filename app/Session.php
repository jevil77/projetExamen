...
class Session{
    ...
    */
    ...
    // permet de savoir si l'utilisateur a le rôle d'administrateur
...
// Fournit les méthodes relatives à la session, elle permet également de vérifier qu'un utilisateur est bien connecté