...
// Un namespace permet de regrouper des classes, interfaces, fonctions et des constantes afin d'éviter les conflits de noms
...
// L'Autoloader permet de charger automatiquement les classes quand on les utilise